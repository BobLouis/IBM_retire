...
# 模式二 #
##########
# TODAY = str(datetime.datetime.now() - datetime.timedelta(days=60))[:10]
# SAVING_DAY = str(datetime.datetime.now() - datetime.timedelta(days=60))[:10]
# TRAINING_DAY = str(datetime.datetime.now() - datetime.timedelta(days=60))[:10]
# 目前沒有5/19以後離職員工資料，因此先抓4/1-5/19離職員工，實際使用請改成上方程式
TODAY = "2021-04-01" 
SAVING_DAY = "2021-04-01"
TRAINING_DAY = "2021-04-01"
##########
# 模式二 #
##########
TBL = TBL_process()
